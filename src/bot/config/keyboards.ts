...
import { kgs } from "@/bot/helpers/units.js";
import { getCompletedSetsString } from "@/bot/helpers/workoutStats.js";
...
export type InlineKeyboardOptions = {
...
export function generateExerciseOptions(
  ...
  todaysExercises.text(backButton, `${prefix}:goBack`).row();
...
export const getWeightOptions = (
  ...
  const weightIncrements =
    unit === "kg" ? weightIncrementsKg : weightIncrementsLb;
