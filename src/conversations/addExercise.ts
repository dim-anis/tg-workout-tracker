...
export const ADD_EXERCISE_CONVERSATION = "addExercise";

export function addExerciseConversation() {
  return createConversation(async function (
    ...
    try {
      ...
      const nameOptions: InlineKeyboardOptions = {
        parse_mode: "HTML",
